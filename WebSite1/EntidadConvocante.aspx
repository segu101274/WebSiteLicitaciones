<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="EntidadConvocante.aspx.cs" Inherits="EntidadConvocante" %>
    ...
    <div>
        <div class="form-horizontal">
            <div class="text-capitalize text-left h3 bg-success">
                <strong>Mantenimiento de Entidad Convocante</strong>
            </div>
            <div class="form-group has-success has-feedback">
                <label class="control-label col-sm-3" for="inputSuccess3">Código de entidad convocante</label>
                <div class="col-sm-2">
                    <dx:ASPxTextBox ID="txtCod" runat="server" CssClass="form-control" MaxLength="2" onkeypress="return numbersonly(event);" onkeyup="nextControl(this);">
                    </dx:ASPxTextBox>
                </div>
            </div>
            <div class="form-group has-success has-feedback">
                <label class="control-label col-sm-3" for="inputSuccess3">RUC Entidad</label>
                <div class="col-sm-6">
                    <dx:ASPxTextBox ID="txtRucEntidad" runat="server" CssClass="form-control" MaxLength="11">
                    </dx:ASPxTextBox>
                </div>
            </div>
            <div class="form-group has-success has-feedback">
                ...
                <div class="col-sm-6">
                    <dx:ASPxTextBox ID="txtDescripcion" runat="server" CssClass="form-control" MaxLength="100">
                    </dx:ASPxTextBox>
                </div>
            </div>
            <div class="form-group has-success has-feedback">
                <label class="control-label col-sm-3" for="inputSuccess3">Dirección</label>
                <div class="col-sm-6">
                    <dx:ASPxTextBox ID="txtDireccion" runat="server" CssClass="form-control" MaxLength="200">
                    </dx:ASPxTextBox>
                </div>
            </div>
            <div class="form-group has-success has-feedback">
            ...
            <div class="form-group has-success has-feedback">
                <div class="col-sm-12 text-center center-block quitar-float">
                    ...
                    <dx:ASPxGridView ID="gdvLista" runat="server" AutoGenerateColumns="False" Width="80%"
                        OnRowCommand="gdvListaActividades_RowCommand" KeyFieldName="codEnt"
                        ...
                        <Columns>
                            ...
                            <dx:GridViewDataTextColumn Caption="Código" VisibleIndex="1" Width="30px" FieldName="codEnt">
                            </dx:GridViewDataTextColumn>
                            <dx:GridViewDataTextColumn Caption="RUC" VisibleIndex="2" Width="150px" FieldName="rucEnt">
                            </dx:GridViewDataTextColumn>
                            <dx:GridViewDataTextColumn Caption="Descripcion" VisibleIndex="2" Width="150px" FieldName="desEnt">
                            </dx:GridViewDataTextColumn>
                            <dx:GridViewDataTextColumn Caption="Dirección" VisibleIndex="2" Width="150px" FieldName="dirEnt">
                            </dx:GridViewDataTextColumn>
                            <dx:GridViewDataTextColumn Caption="Estado" VisibleIndex="4" Width="70px" FieldName="estEnt">
                            </dx:GridViewDataTextColumn>
